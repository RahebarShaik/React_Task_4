        ...
        <tbody className="tbody">
          {users.map((details) => (
            <tr key={details.id}>
              ...
              <td>
                {<img src={details.image} alt={"/"} width="30" height="30" />}
              </td>
              ...
              <td>
                {details.address.coordinates.lat +
                  "," +
                  details.address.coordinates.lng}
              </td>
              ...
              <td>
                {details.company.address.coordinates.lat +
                  "," +
                  details.company.address.coordinates.lng}
              </td>
